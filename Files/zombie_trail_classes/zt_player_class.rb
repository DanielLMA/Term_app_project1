...
class CharacterSpeedy
  ...
  #zombie attack probability results based on what the defense, offense, and agility stats are.
  #allows the ability to have different zombie attacks that can change outcomes based on which zombie is attacking and what the player's stats are.
  def zombie_attack
